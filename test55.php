...
// Database connection
$idr = mysqli_connect("192.168.1.104", "root", "1Sys9Admeen72", "nccleb_test");
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="action-buttons">
                <button class="btn btn-success" onclick="window.open('http://192.168.1.104/test275.php?page=<?php echo urlencode($naa); ?>&page1=<?php echo urlencode($idf); ?>&page2=<?php echo urlencode($inc); ?>','','menubar=0,resizable=1,width=680,height=950')">
