...
function openWin() {
 ...
 var popup = window.open ("http://192.168.1.104//test19.php");
 
    $(popup.document).ready(function() {
       
		popup.window.top.location("http://192.168.1.104//test19.php");
	});     
}		
...
function leads(){
 ...
 window.open ("http://192.168.1.104//test82.php","","menubar=0,resizable=1,width=950,height=750");
...
function search(){
 ...
 window.open ("http://192.168.1.104//search.php","","menubar=0,resizable=1,width=480,height=620");
...
function number(){
 ...
 window.open ("http://192.168.1.104//numbersearch.php","","menubar=0,resizable=1,width=480,height=435");
...
function add(){
	...
	myw=window.open ("http://192.168.1.104//test56.php?page=<?php echo $nam ?>&page1=<?php echo $idf ?>&page2=<?php echo $num9 ?>","","menubar=0,resizable=1,width=450,height=800");
}
</script> 
...
function add2(){
	...
	myw=window.open ("http://192.168.1.104//test276.php?page=<?php echo $nam ?>&page1=<?php echo $idf ?>&page2=<?php echo $num9 ?>","","menubar=0,resizable=1,width=450,height=800");
}
</script> 
...
function del(){
 ...
 window.open ("http://192.168.1.104//test68.php","","menubar=0,resizable=1,width=480,height=350");
...
function update(){
	...
	myw=window.open ("http://192.168.1.104//before.php?pag=<?php echo $nam ?>&pag1=<?php echo $idf ?>&pag2=<?php echo $num9 ?>","","menubar=0,resizable=1,width=500,height=800");
}
</script> 
